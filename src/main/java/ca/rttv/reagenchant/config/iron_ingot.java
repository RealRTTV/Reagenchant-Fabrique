...
public class iron_ingot {

    public static File configFile = new File(JsonHelper.getConfigDirectory(), "iron_ingot.json");
    ...
    public static JsonObject generateDefaultConfig() {
...

        {
            ...
            jsonObject.addProperty("enchantment", "minecraft:punch");
        ...
        {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("enchantment", "minecraft:projectile_protection");
            jsonObject.addProperty("minimumEnchantmentLevel", 1);
        ...
        {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("enchantment", "minecraft:knockback");
            jsonObject.addProperty("minimumEnchantmentLevel", 1);
            jsonObject.addProperty("maximumEnchantmentLevel", 2);
            jsonObject.addProperty("probability", 0.5f);
            jsonObject.addProperty("reagentCost", 1);
