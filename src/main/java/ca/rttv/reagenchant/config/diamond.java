...
public class diamond {
    ...
    public static File configFile = new File(JsonHelper.getConfigDirectory(), "diamond.json");
    ...
    public static JsonObject generateDefaultConfig() {
...

        {
            ...
            jsonObject.addProperty("enchantment", "minecraft:looting");
        ...
        {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("enchantment", "minecraft:fortune");
            jsonObject.addProperty("minimumEnchantmentLevel", 1);
            jsonObject.addProperty("maximumEnchantmentLevel", 3);
            jsonObject.addProperty("probability", 0.5f);
            jsonObject.addProperty("reagentCost", 1);
        ...
        {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("enchantment", "minecraft:multishot");
            jsonObject.addProperty("minimumEnchantmentLevel", 1);
