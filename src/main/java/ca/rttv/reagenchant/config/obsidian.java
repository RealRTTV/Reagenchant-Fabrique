...
public class obsidian {
    ...
    public static File configFile = new File(JsonHelper.getConfigDirectory(), "obsidian.json");
    ...
    public static JsonObject generateDefaultConfig() {
        ...
        json.addProperty("item", "minecraft:obsidian");

        JsonArray enchantments = new JsonArray();

        {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("enchantment", "minecraft:unbreaking");
